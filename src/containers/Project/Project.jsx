          ...
          <>
            ...
            <section>
              <div className="app__project-logo">
                <img src={work["logo"]} alt="project-logo" style={{ backgroundColor: work["color"] }} />

                <div className="app__flex-end">
                  {work["websiteurl"].length > 2 && (
                    <a href={work["websiteurl"]} rel="external" target="_blank" className="app__flex" style={{ backgroundColor: work["color"] }}>
                      <p className="p-text p-link">نسخه‌ی لایو</p>
                      <ImEye />
                    </a>
                  )}

                  <Link to="/works" rel="noopener noreferrer" className="app__flex app__project-back">
                ...
                {work["aparatID"].length > 2 && (
                  <div className="app__project-contentbox">
                    ...
                    <div className="h_iframe-aparat_embed_frame">
                      <span />
                      <iframe
                        src={`https://www.aparat.com/video/video/embed/videohash/${work["aparatID"]}/vt/frame`}
