          ...
          <div className="app__flex app__contacts-form">
            <span>
              ...
              <ul className="app__flex-start app__contacts-social">
                ...
                <a href="https://www.linkedin.com/in/aminthemar" target="_blank" rel="noreferrer">
                  <RiLinkedinBoxLine />
                </a>
                <a href="https://eitaa.com/aminthemar" target="_blank" rel="noreferrer">
                  <RiWhatsappLine />
                </a>
                <a href="https://t.me/aminthemar" target="_blank" rel="noreferrer">
                  <RiTelegramLine />
                </a>
              </ul>
              <iframe
            ...
            <section>
              <form action="/action_page.php">
                <div className="app__flex-start app__contacts-error">
                  <label className="p-text p-link" htmlFor="email">
                    ایمیل شما
                  </label>
                ...
                <div className="app__flex-start app__contacts-error">
                  <label className="p-text p-link" htmlFor="message">
                    متن درخواست
                  </label>
