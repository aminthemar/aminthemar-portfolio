    ...
    <div className="app__unity-bg">
      ...
      <div className="app__flex-start">
        <div className="app__unity section_pad">
          <div className="app__unity-header">
            <div>
              ...
              <span className="app__flex-start">
                <a href="https://www.aparat.com/AminTheMar" target="_blank" rel="noreferrer" className="app__flex-start app__unity-teacher button_icon">
                  <BsFillPersonFill />
              ...
              <p className="p-text">
                یادگیری کار با موتور بازی‌سازی یونیتی بسیار ساده و لذت‌بخش است! در این مجموعه‌ی آموزشی به طراحی، برنامه‌نویسی و عرضه‌ی نهایی یک بازی ساده‌ی
                اندرویدی می‌پردازیم.
              </p>
            </div>
            <motion.img
          ...
          >
            {unity_thumbs.map((item, index) => (
              <li key={`unity-${index}`} onClick={() => handleImageOpen(item[1])}>
                <section>
                  <img src={item[0]} alt={`محمدامین-رشید-unity-tutorial-${index}`} />
          ...
          <a href="https://www.aparat.com/playlist/1214480" target="_blank" rel="next">
