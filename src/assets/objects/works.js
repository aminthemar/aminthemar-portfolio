...
const data = {
  ...
  content: {
    balloons: {
      ...
      category: "بازی",
      description:
        "بادکنک‌ها یک بازی هایپرکژوال دوبعدی برای پلتفرم اندروید است که بازیکن در آن را باید بادکنک‌های معلق را نسبت به رنگ‌های تعیین شده بترکاند. با دریافت امتیاز بیشتر، بازی به صورت نمایی سخت‌تر می‌گردد. این بازی ابتدا یک ایده‌ی دم‌دستی برای مجموعه‌ی آموزشی من با نام «آموزش ساخت بازی اندروید با یونیتی» در آپارات بود که بعداً به یک بازی مستقل تبدیل شد.",
      tags: ["Unity", "C-Sharp", "Photoshop", "انیمیشن"],
      screenshots: [
        images_works.balloons_shot_1,
        images_works.balloons_shot_2,
        images_works.balloons_shot_3,
        images_works.balloons_shot_4,
        images_works.balloons_shot_5,
      ],
      date: "فروردین 1398",
    ...
    security: {
      ...
      category: "بازی",
      description:
        "یک بازی ویدئویی موبایلی درباره‌ی امنیت سایبری و فیشینگ در فضای مجازی است. این بازی در سبک «ماجرای خود را انتخاب کن» طراحی شده و چندین پایان مختلف دارد؛ طوری که بازیکن با تصمیم‌های خود روی روند داستان تأثیر گذاشته و نسبت به درستی یا نادرستی آنها، یکی از چند پایان مختلف بازی را تجربه می‌کند.",
    ...
    raf: {
      ...
      category: "لوگو",
      description:
        "راف دکو یک پیمانکار طراحی آشپزخانه و دکوراسیون داخلی در شهر قم است که وظیفه‌ی طراحی برند، کارت ویزیت، لوگو، دفترچه و... آن بر عهده‌ی من قرار داده شد.",
      tags: ["Photoshop", "Illustrator"],
      screenshots: [images_works.raf_shot_1, images_works.raf_shot_2, images_works.raf_shot_3, images_works.raf_shot_4],
      date: "مهر 1399",
    ...
    choobkhat: {
      ...
      category: "لوگو",
      description:
        "استودیو چوب‌خط یک برند تولید بازی‌های ویدئویی است که من برای رسمی‌سازی و اثبات مالکیت پروژه‌های شخصی خودم ایجاد کرده‌ام. همچنین، تحت این نام به مدت دو سال به تولید محتوا درباره‌ی نحوه‌ی ساخت بازی‌های ویدئویی در اینستاگرام و آپارات پرداخته شده است.",
    ...
    studiar: {
      ...
      category: "لوگو",
      description:
        "استادیار یک پلتفرم آنلاین بوده که برای اشتراک و خرید ویدئو‌های آموزشی برنامه‌نویسی (چیزی مثل Udemy) طراحی شده است. مدرس‌ها می‌توانند در یک بستر شبکه‌ی اجتماعی برای دنبال‌کنندگان خود کورس‌های آنلاین یا از پیش ضبط شده برگزار کرده و برای آنها تمرین تعریف کنند. این پروژه‌ی استارت‌آپی در نهایت به علت تغییر کاربری کنسل شد. طراحی لوگوی این وبسایت بر عهده‌ی من بوده است.",
      tags: ["Photoshop", "Illustrator"],
      screenshots: [images_works.studiar_shot_1, images_works.studiar_shot_2],
      date: "مهر 1398",
      websiteurl: "#",
      aparatID: "#",
      color: "#ffc233",
    ...
    dorm: {
      ...
      category: "پوستر",
      description:
        "در سال 98، دانشگاه قم به مناسبت هفته‌ی سراهای دانشجویی مسابقه‌ای برگزار کرد و برای طراحی بهترین پوستر، یک جایزه‌ی 2 میلیون تومانی گذاشت. این پوستر با وام‌گیری از سبک گرافیکی بازی Monument Valley طراحی شد اما مقام اول را کسب نکرد.",
      tags: ["Photoshop", "Illustrator"],
      screenshots: [images_works.dorm_shot_1, images_works.dorm_shot_2, images_works.dorm_shot_3],
      date: "اردیبهشت 1398",
