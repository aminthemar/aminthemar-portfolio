    ...
    content: [
        {
            ...
            "logo": images.edu_6,
            "place": "استعلام مدرک",
            "description": "معتبر تا اسفند 1403 - وزارت علوم، تحقیقات و فناوری ایران آزمون MSRT را برای داوطلبان دکتری کشور در نظر گرفته است. با توجه به میزان سختی سوالات، تنها 20 درصد از متقاضیان نمره‌ی قبولی (50 به بالا) را کسب می‌نمایند. سطح دشواری آزمون MSRT در سطح آزمون‌های بین المللی بوده که به آزمون تافل کوچک معروف است.",
            "grade": "76 از 100",
            "rank": "A",
        },
        {
