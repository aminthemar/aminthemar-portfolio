...
const data = {
    ...
    content: [
        ...
        },
        {
            ...
            "logo": images.edu_5,
            "place": "چکیده‌ی پژوهش",
            "description": "استخراج شده از پایان‌نامه‌ی کارشناسی ارشد با موضوع «بهبود عملکرد ساده‌سازی بدون نظارت جملات با استفاده از مدل‌های زبانی پوشیده» - استاد راهنما: دکتر حسین امیرخانی\nچاپ شده در ژورنال Pattern Recognition Letters (2023)، نشر Elsevier",
            "grade": "19 (عالی)",
            "rank": "ژورنال Q1",
        },
        {
